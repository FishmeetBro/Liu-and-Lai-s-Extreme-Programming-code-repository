<template>
  <div>
    ...
    <div style="margin: 10px 0">
      ...
      <el-upload :action="'http://localhost:9090/user/import2'" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
...
id:'',
 ...
 socialList: [{
  ...
  methods: {
    ...
    exp() {
      window.open("http://localhost:9090/user/export2")
    },
